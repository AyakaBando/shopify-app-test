ShopifyApp.configure do |config|
  ...
  config.api_key = ENV['SHOPIFY_API_SECRET']
  config.scope = "read_products, read_orders, read_customers, write_customers, read_orders" # Consult this page for more scope options:
